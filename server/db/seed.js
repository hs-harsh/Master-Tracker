...
async function seedCashflow(data) {
  ...
  for (const row of data) {
    ...
    `, [
      row.month,
      row.person,
      Math.round(row.income || 0),
      Math.round(row.other_income || 0),
      Math.round(row.major_expense || 0),
      Math.round(row.non_recurring_expense || 0),
      Math.round(row.regular_expense || 0),
      Math.round(row.emi || 0),
      Math.round(row.trips_expense || 0),
      Math.round(row.net_expense || 0),
      Math.round(row.ideal_saving || 0),
      Math.round(row.actual_saving || 0),
      Math.round(row.target || 0),
      Math.round(row.corpus || 0),
      Math.round(row.cash || 0),
      Math.round(row.gold_silver || 0),
      Math.round(row.debt_pf || 0),
      Math.round(row.debt_ppf || 0),
      Math.round(row.debt_mf || 0),
      Math.round(row.equity_indian || 0),
      Math.round(row.equity_intl || 0),
      Math.round(row.equity_nps || 0),
      Math.round(row.equity_trading || 0),
      Math.round(row.equity_smallcase || 0),
      Math.round(row.real_estate || 0),
      Math.round(row.home_loan || 0),
      Math.round(row.personal_loan || 0),
      Math.round(row.owed_friends || 0),
      Math.round(row.net_total || 0),
      Math.round(row.total_asset || 0),
      Math.round(row.liability || 0),
      Math.round(row.net_asset || 0),
      row.low_risk_pct || 0,
      row.medium_risk_pct || 0,
      row.high_risk_pct || 0
    ]);
    count++;
  }
